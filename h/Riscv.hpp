...
public:
    ...
    // Setting privilege depending on thread privilege level
    static void SetPrivilegeLevelForRunningThread() {
...
private:
    ...
    static void WriteReturnedValue(uint64);
...
inline void Riscv::WriteReturnedValue(uint64 retVal) {
